...
interface IconProps {
  ...
  style: React.CSSProperties; // Use style object for positioning
  tooltip: string;
}
...
const Icon = ({
  ...
  return (
    <motion.div
      ...
      key={iconData.id}
      style={{
        ...iconData.style, // Apply position from style prop
        x: springX,
        y: springY,
      }}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        <AmigoalLogo className="h-32 w-32 mx-auto mb-4" />
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight bg-gradient-to-b from-foreground to-foreground/70 text-transparent bg-clip-text font-headline">
          {title}
        </h1>
        ...
        <div className="mt-10">
          <Button onClick={onCtaClick} size="lg" className="px-8 py-6 text-base font-semibold">
            {ctaText}
          </Button>
        </div>
      </div>
