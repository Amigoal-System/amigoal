...
export interface ReferralCardProps {
  ...
  className?: string;
  /** Optional click handler for direct referral button */
  onDirectReferralClick?: () => void;
}
...
export const ReferralCard = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative w-full max-w-none overflow-hidden rounded-2xl border bg-card p-6 text-card-foreground shadow-lg sm:p-8",
        className
      )}
    >
      {/* Decorative image */}
        ...
        <div>
          ...
          >
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2">
             ...
             {onDirectReferralClick && (
                <Button onClick={onDirectReferralClick} variant="secondary" className="w-full">
                    Verein direkt empfehlen
                </Button>
             )}
          </motion.div>
        </div>
