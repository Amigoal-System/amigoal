...
type MenuOption = "Auto" | "Max" | "Search" | "Plan" | "Verein" | "Trainer" | "Spieler" | "Fussballschulen" | "Sponsor";
  ...
  return (
    <ChatInputContext.Provider value={contextValue}>
      <form
        ...
        className={`relative mx-auto min-h-12 ${'\'\'\''}{baseWidthClass} transition-all duration-${'\'\'\''}{animationDuration} ease-out ${focusWidthClass} translate-y-0 opacity-100`}
        style={{
