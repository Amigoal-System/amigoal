      ...
      <div className="flex flex-col items-center group/he select-none">
        <div className="relative z-0 h-16 -mb-2 transition-all duration-200 group-hover/he:h-0">
          <svg
            ...
            height="128"
            viewBox="0 0 128 128"
            className="duration-500 rounded-full"
          >
            <rect width="128" height="128" rx="16" fill="#1e293b" />

            <circle cx="64" cy="64" r="28" fill="#10b981" />
            <polygon
              points="58,50 58,78 78,64"
              fill="white"
              className="transition-transform duration-300 hover:scale-110"
            />

            <path
              d="M92 64c0-4 2-8 6-10M92 64c0 4 2 8 6 10"
              fill="none"
              stroke="#10b981"
              strokeWidth="2"
              strokeLinecap="round"
            ...
            />
            <path
              d="M98 54c0-6 3-12 8-15M98 74c0 6 3 12 8 15"
              fill="none"
              stroke="#10b981"
              strokeWidth="2"
              strokeLinecap="round"
              className="animate-[pulse_1.5s_0.2s_infinite]"
            />
          </svg>
        ...
        <div className="z-30 flex flex-col w-40 h-20 transition-all duration-300 bg-white shadow-md group-hover/he:h-40 group-hover/he:w-72 rounded-2xl shadow-zinc-400">
          <div className="flex flex-row w-full h-0 group-hover/he:h-20">
            <div className="relative flex items-center justify-center w-24 h-24 group-hover/he:-top-6 group-hover/he:-left-4 opacity-0 group-hover/he:animate-[spin_3s_linear_infinite] group-hover/he:opacity-100 duration-100">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="128"
                height="128"
              ...
              <div className="absolute z-10 w-6 h-6 bg-white border-4 rounded-full shadow-sm border-zinc-400 top-8.5 left-7"></div>
            </div>
            <div className="flex flex-col justify-center w-full pl-3 -ml-24 overflow-hidden group-hover/he:-ml-3 text-nowrap">
              <p className="text-xl font-bold">Audio Aufnahme</p>
              <p className="text-zinc-600">Schiedsrichter</p>
            </div>
          </div>
